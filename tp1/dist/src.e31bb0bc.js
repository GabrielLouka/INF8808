...
function updateHeader() {
  ...
  console.log(head); //        * An 'h1' element with text : 'TP1'

  head.appendChild(document.createElement('h1')).textContent = 'TP1'; //        * A'div' element with text : 'Bienvenue au cours INF8808 : Visualisation de données.'
...
function updateInfoPanel() {
  ...
  dotCountLabel.innerHTML = "<b>".concat(count, "</b>");
